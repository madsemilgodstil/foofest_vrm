...
const Footer = () => {
  return (
    <div className="relative">
      {/* Content container */}
      <div className="relative z-10 py-10 px-2 max-w-7xl mx-auto">
        ...
        <p className="text-sm mt-6">© 2024 My Company. All rights reserved.</p>
      </div>

      {/* SVG Background */}
      <div
        className="absolute inset-0 bg-cover bg-center h-800"
        style={{
          backgroundImage: "url('/footerfest3.svg')",
        }}
      ></div>
    </div>
  );
